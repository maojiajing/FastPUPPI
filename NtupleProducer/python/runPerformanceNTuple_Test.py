...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ Local Jet clustering ~~~~~
from FastPUPPI.NtupleProducer.P2L1TPFJets_cfi import SeedJet, P2L1TJet
...
def monitorPerf(label, tag, makeResp=True, makeRespSplit=True, makeJets=True, makeMET=True, makeCentralMET=True, makeBarrelMET=True):
    ...
    if makeJets:
        ...
        setattr(process.l1pfjetTable.jets, 'al4'+label, cms.InputTag('ak4'+label))
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ Start the jet clustering study ~~~~~
        _add('seed4'+label, SeedJet.clone(src = tag))
